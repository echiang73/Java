...
// Alternative solution using getSimpleName (same parent) without unnecessary overriding methods in children (works on IDE but won't pass checker since not polymorphism)
public class Car {
    private boolean engine;
    private int cylinders;
    private String name;
